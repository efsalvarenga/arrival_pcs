...
While *Grit* represents your physical and mental resistance, *Ego* represents your ability to keep pushing.

Roll $1d$ to determine your initial *Grit* and *Ego.*
*Grit* and *Ego* dice are exploding dice (i.e. if the result is a $6$, keep rolling and accumulating the result).
...
If you did not rest well you have $-1d$ to roll (with $1$ *Grit* as minimum if you have $0d$).
You may choose to consume **Primer** spores (or drugs based on these spores) and roll to reset your *Ego.*

#### Ailments {-}

You lose *Grit* when you are mentally strained or physically harmed. 
When your *Grit* reaches $0$ you are lost somehow.
With the GM determine how your last scene goes.

Anytime you are strained or harmed, you can choose to gain an *Ailment* instead of losing *Grit*.
You have $3$ *Ailment* tracks: Stressed ($-1d$ **Insight**), Broken ($-1d$ **Prowess**) and Weary ($-1d$ **Resolve**).
Each *Ailment* track recovers through appropriate care and a week of rest.

If you mark all $3$ *Ailment* tracks you fall unconscious.
If you survive, you develop a malaise.
...
|     | Malaises                                                                           |
| :-: | ---------------------------------------------------------------------------------- |
| $1$ | Re-roll your *Grit* with $-1d$ from now on. You die if it goes below $0d$.         |
| $2$ | When you re-roll your *Ego,* use $-1d$ from now on. You die if it goes below $0d$. |
| $3$ | $-1$ **Insight**, you die if it goes below $0$.                                    |
| $4$ | $-1$ **Resolve**, you die if it goes below $0$.                                    |
| $5$ | $-1$ **Prowess**, you die if it goes below $0$.                                    |
| $6$ | No malaise.                                                                        |
...
| Die Hard        | When you reset your *Grit*, roll $+1d$ and keep the highest.                                                                                                                                   |
...
Whenever your new *Ego* is lower than the current number of *Conditions*, you gain an Stigma *Condition* as well. `DR2`
