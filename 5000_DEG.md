...
You may choose to consume **Primer** spores (or drugs based on these spores) to roll and reset your *Ego*.
Consult the highest value of your roll on the table below.

|       | Outcome                                                                          |
| :---: | -------------------------------------------------------------------------------- |
| $1:3$ | Reset your *Ego* to $3$. You algo gain a Stigma. `DR2`                           |
| $4:5$ | Reset your *Ego* to your roll, and roll a detrimental mutation. `MORPH 127-129`  |
